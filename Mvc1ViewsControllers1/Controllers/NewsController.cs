...
namespace Mvc1ViewsControllers1.Controllers
{
    public class NewsController : Controller
    {
...

        {
            ...
            listFromDb.Add(new News { Id=1, Headline = "Extremkyla drar in", NewsText = @"Stora snömängder i södra Sverige Redan på tisdag kommer ett lågtryck in över de södra delarna av Sverige, vilket kan orsaka stora snöfall i Götaland. Det ser att att vara rätt stora mängder. Det kan vara frågan om decimeter snö i Götaland, säger Per Holmberg, Meteorolog på Storm." });

            listFromDb.Add(new News {Id=2, Headline = "Spelet bakom svenska segerrycket", NewsText = @"Svenska lagets taktik låg bakom Ebba Anderssons segerryck.
...
– Det var precis som planerat, jag bara skrek" });
            ...
            listFromDb.Add(new News { Id=3, Headline = "Säkerhetsanalytikerns varning: ”De säger att detta bara är början”", NewsText = @"Många av dessa personer känner att de har momentum, och säger att detta bara är början. Det kan bli en snöbollseffekt" });
